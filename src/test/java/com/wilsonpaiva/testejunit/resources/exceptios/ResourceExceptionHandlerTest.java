package com.wilsonpaiva.testejunit.resources.exceptios;
...
class ResourceExceptionHandlerTest {
    ...
    @Test
    void whenOjectNotFoundExceptionThenReturnAdResponseEntity() {
    ...
    void dataIntegrityViolationException() {
        ResponseEntity<StandardError> response = exceptionHandler.dataIntegrityViolationException
                (new DataIntegratyViolationException(E_MAIL_JA_CADASTRADO),new MockHttpServletRequest());
        assertNotNull(response);
        assertNotNull(response.getBody());
